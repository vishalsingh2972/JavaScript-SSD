...
//adding eventlistener to body this time, so that if we type anywhere on the page we can still run the code
document.body.addEventListener('keydown', (event) => { //same as mentioned before (in 9-3 html) whatever input we enter on keyboard gets saved in the JS special object 'event'
  //console.log('keydown');
